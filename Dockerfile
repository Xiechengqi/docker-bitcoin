...
LABEL fullnode.build_cmd="docker build --force-rm --no-cache --build-arg BUILD_DATE=$(date -u +'%Y-%m-%dT%H:%M:%SZ') --build-arg VERSION=$VERSION -t fullnode/bitcoin:$VERSION -f ./Dockerfile ."
